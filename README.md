...
This is a sample template for chocolate-three - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name chocolate-three --query 'Stacks[].Outputs'
```
